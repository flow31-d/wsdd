...
npx github:flow31-d/wsdd#v0.4.8 install
```
...
npm test                          # 16 gates de instalação PASS
...
2. **`npm test` (16 gates) é o gate mínimo** para qualquer push, incluindo docs.
...
7. **O privado testa primeiro.** Se uma mudança não passou nos 16 gates localmente, não vai para o público, mesmo que pareça trivial.
